...
export default function EditPost() {
    ...
    useEffect(() => {
        ...
        async function fetchPostData() {
            try {
                const response = await requester.get(`http://localhost:3030/data/posts/${id}`, null, { headers: { 'X-Authorization': token }, signal });
    ...
    async function formAction(formData) {
        ...
        try {
            await requester.put(`http://localhost:3030/data/posts/${id}`, { ...post, ...postData, _id: id }, { headers: { 'X-Authorization': token } });
